...
{
    public partial class OtherUserSupplierPaymentDetailsManager : MetroFramework.Forms.MetroForm
    {
        ...
        public OtherUserSupplierPaymentDetailsManager(List<PaymentDetail> payments)
        {
