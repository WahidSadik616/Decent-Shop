...
{
    public partial class OtherUserSellDetailsManager : MetroFramework.Forms.MetroForm
    {
        ...
        public OtherUserSellDetailsManager(List<SellDetail> sellProduct)
        {
            _sellDetailss = sellProduct;
            InitializeComponent();
        }
